...
/**
 * Class for Zend\View\Strategy\RenderingStrategy to help enforce private constructs.
 *
 ...
 */
class BlitzRenderer implements Renderer, TreeRendererInterface
{
    ...
    /**
     * @var array ArrayAccess or associative array representing available variables
     */
    private $__vars = [];
    ...
    /**
     * Allow custom object initialization when extending BlitzRenderer
     *
     ...
     * separately, but instead pass the root view model directly to the BlitzRenderer.
